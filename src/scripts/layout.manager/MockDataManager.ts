...
export class MockDataManager implements IDataManager {
    ...
    logo = this.dom.window.document.createElement('img')
    ...
    searchInputs = this.dom.window.document.querySelectorAll('input[type="search"]') as NodeListOf<HTMLElement>
    ...
    setProperty(parentProperty:any, propertyName: string, value: any) {
        Object.defineProperty(parentProperty, propertyName, { value: value, writable: true })
    }
}