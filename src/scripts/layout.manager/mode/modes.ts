...
export abstract class Modes implements IModes {
    ...
    abstract calculateAvailableDimensions(dm: IDataManager): { availableHeight, availableWidth }
    ...
    getAvailableHeight(dm: IDataManager) {
        ...
        let availableHeight = innerHeight - headerHeight - footerHeight - breadcrumbHeight
